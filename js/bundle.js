...
function cards() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_2__.getResource)('http://localhost:3000/menu').then(function (data) {
...
function forms(formSelector, modalTimerId) {
  ...
  var message = {
    ...
    success: "Спасибо! Оператор свяжется с Вами",
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2022-06-01');
});
}();
/******/ })()
;
